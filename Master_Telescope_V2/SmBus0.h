/*===========================================================================*=
	Master_Telescope - Smbus - Tanguy Dietrich
  =============================================================================
   Descriptif: 
...
#define  SMB_FREQUENCY  30000          // gTarget SCL clock rate
...
#define  NUM_BYTES_MAX_WR   5          // Number of bytes to write
                                       // Master -> Slave
#define  NUM_BYTES_MAX_RD   5          // Number of bytes to read
                                       // Master <- Slave